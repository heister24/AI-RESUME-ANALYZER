        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="mt-6 text-5xl font-extrabold tracking-tight sm:text-6xl">
              Sign in to your <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500">workspace.</span>
            </h1>
            <p className="mt-6 text-xl leading-relaxed text-gray-600">
              Pick up where you left off. Turn your resume into your next opportunity with sharper scores and clearer feedback.
            </p>
          </div>
