        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          ...
          >
            ...
            <h1 className="mt-6 text-5xl font-extrabold tracking-tight sm:text-6xl">
              Let&apos;s make your next application{" "}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500">
                sharper.
              </span>
            </h1>
            <p className="mt-6 text-xl leading-relaxed text-gray-600">
              Have a question or an idea for ResumeLens? Send us a note and our
            ...
            >
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    className="min-h-40 w-full resize-y rounded-2xl border border-gray-200 bg-white/80 px-5 py-4 text-gray-900 shadow-sm outline-none transition-all focus:ring-4 focus:ring-emerald-500/20"
